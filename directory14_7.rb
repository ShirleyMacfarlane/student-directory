#Chapter 14 exercise 1 : Refactor code to only add the student in a new method
#Chapter 14 exercise 2 : Default to load students.csv on start up
#Chapter 14 exercise 3 : Refactor Code
#Chapter 14 exercise 4 : Implement user feedback messages
#Chapter 14 exercise 5 : Get filename from user
#Chapter 14 exercise 7 : Working with csv files
...
#Try to laod the file from the command line, if no file entered default to use the students.csv file
...
#Request the fielname from the user
